...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CSPieChart/CSPieChart.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HCLineChartView/HCLineChartView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IQKeyboardManager/IQKeyboardManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KDCircularProgress/KDCircularProgress.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KUIPopOver/KUIPopOver.framework"
